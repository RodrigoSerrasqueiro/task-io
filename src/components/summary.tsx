...
import { TaskIoIcon } from './task-io-icon';
          ...
          <div className="flex flex-col gap-4">
            ...
            <ul className="flex flex-col gap-3">
              ...
              <li className="flex items-center gap-2">
                ...
                <span className="text-sm text-zinc-400">
                  Você completou{' '}
                  <span className="text-zinc-100">"Praticar exercícios"</span>{' '}
                  às <span className="text-zinc-100">10:45h</span>
                </span>
              </li>
            </ul>
          </div>
            ...
            <ul className="flex flex-col gap-3">
              <li className="flex items-center gap-2">
                ...
                <span className="text-sm text-zinc-400">
                  ...
                  às <span className="text-zinc-100">9:15h</span>
                </span>
              </li>
              ...
              <li className="flex items-center gap-2">
                ...
                <span className="text-sm text-zinc-400">
                  ...
                  <span className="text-zinc-100">18:24h</span>
                </span>
              </li>
            </ul>
          </div>
